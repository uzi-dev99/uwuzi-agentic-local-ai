...
const ChatHeader: React.FC<ChatHeaderProps> = ({ chatId, chatTitle, onSaveTitle }) => {
    ...
    return (
        <header className="flex-shrink-0 p-2 md:p-4 border-b border-border/50 bg-secondary/50 backdrop-blur-sm z-10">
            <div className="max-w-4xl mx-auto w-full min-w-0 px-1 sm:px-0 flex items-center">
